...
for l in lis2:
    l=l.strip()
    l=l.split()
    if l[5] in dic2.keys() and dic2[l[5]]!=[]:
        for i in dic2[l[5]]:
             ID=tuple([l[0],l[5],i[0],i[1]])
             dic3[ID]=[]
             dic4[ID]=[]
for l in lis2:
    l=l.strip()
    ...
    if l[5] in dic2.keys() and dic2[l[5]]!=[]:
        for i in dic2[l[5]]:
             ...
             if int(l[8])<=int(i[0]):
                   if dic3[ID]==[]:
                      dic3[ID]=[l[2],l[3],l[7],l[8],l[1]]
                      #print("three",ID,dic3[ID])
                   else:
                      if int(l[8])>=int(dic3[ID][3]):
                         dic3[ID]=[l[2],l[3],l[7],l[8],l[1]]
                         #print("three",ID,dic3[ID])
        for i in dic2[l[5]]:
             ID=tuple([l[0],l[5],i[0],i[1]])
             if int(l[7])>=int(i[1]):
                   if dic4[ID]==[]:
                      dic4[ID]=[l[2],l[3],l[7],l[8],l[1]]
                      #print("four",ID,dic4[ID])        
                   else:
                      if int(l[7])<=int(dic4[ID][2]):
                         dic4[ID]=[l[2],l[3],l[7],l[8],l[1]]
                         #print("four",ID,dic4[ID])
dic5={}
for i in dic3.keys():
